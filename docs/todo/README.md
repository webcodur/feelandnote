...
| [`faction-schema-migration.md`](faction-schema-migration.md) | 도감 스키마 이관: celeb_tags 계열 → faction_lv1/lv2/lv3 + faction_members. is_myth·lead_person_ids 신설, 신화 지역을 DB 테마로 |
