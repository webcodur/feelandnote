...
import { COMMON_VOICE_DIR, voiceDir } from '@/features/book-recommend/lib/server-utils'
...
export async function GET(req: Request, { params }: { params: Promise<{ series: string; path: string[] }> }) {
