 ...
 *
 * [명령]  sw/web-bo 에서
 *   node --env-file=.env --import tsx scripts/lock-virtual-monologue.ts --slugs a,b            # 잠금
 *   node --env-file=.env --import tsx scripts/lock-virtual-monologue.ts --unlock --slugs a,b   # 해제
 *   node --env-file=.env --import tsx scripts/lock-virtual-monologue.ts --list                 # 잠긴 인물 목록
 */
