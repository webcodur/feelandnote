...
export function VoiceToolbar({
  ...
  return (
    <div className="relative bg-bg-card border border-border/50 rounded-lg mb-4 overflow-hidden">
      <button
        type="button"
        className={`w-full flex items-center gap-2 px-3 py-2 text-left cursor-pointer select-none outline-none hover:bg-bg-hover ${expanded ? 'border-b border-border/40' : ''}`}
