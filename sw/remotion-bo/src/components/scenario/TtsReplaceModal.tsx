                ...
                return (
                  <li key={r.id} className={`grid grid-cols-[1fr_1fr_auto] items-stretch ${i > 0 ? 'border-t border-border/60' : ''}`}>
                    ...
                    <button
                      ...
                      className="w-12 text-sm text-text-secondary hover:text-danger-text hover:bg-danger-text/10 disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
                      title="이 행 삭제"
                    >
                      ×
                    </button>
