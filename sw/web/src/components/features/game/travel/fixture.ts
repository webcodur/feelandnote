...
type RawEdge = [string, string, { type: "content" | "faction"; label: string }];

const rawEdges: RawEdge[] = [
  // 과학자 클러스터 내부
  ["t-newton", "t-einstein", { type: "content", label: "프린키피아" }],
  ["t-einstein", "t-curie", { type: "faction", label: "노벨 물리학상" }],
  ["t-einstein", "t-feynman", { type: "content", label: "상대성 이론" }],
  ["t-darwin", "t-newton", { type: "content", label: "종의 기원" }],
  ["t-curie", "t-feynman", { type: "faction", label: "노벨 물리학상" }],
  ...
  ["t-tolstoy", "t-dostoevsky", { type: "faction", label: "러시아 문호" }],
  ...
  ["t-lincoln", "t-washington", { type: "faction", label: "미국 대통령" }],
  ["t-lincoln", "t-churchill", { type: "content", label: "게티즈버그 연설" }],
  ["t-churchill", "t-mandela", { type: "content", label: "자유를 향한 긴 여정" }],
  ["t-gandhi", "t-mandela", { type: "faction", label: "비폭력 지도자" }],
  ["t-gandhi", "t-lincoln", { type: "content", label: "자서전" }],
  ["t-caesar", "t-alexander", { type: "faction", label: "고대 정복자" }],
  ["t-washington", "t-churchill", { type: "content", label: "연방주의자 논집" }],

  // 사상가 클러스터 내부
  ["t-socrates", "t-plato", { type: "faction", label: "고대 그리스 철학" }],
  ["t-plato", "t-aristotle", { type: "faction", label: "고대 그리스 철학" }],
  ...
  // 예술가 클러스터 내부
  ["t-davinci", "t-michelangelo", { type: "faction", label: "르네상스 마에스트로" }],
  ...
  // 현대 혁신가 클러스터 내부
  ["t-jobs", "t-gates", { type: "faction", label: "실리콘밸리 거인" }],
  ...
  // 동아시아 클러스터 내부
  ["t-sejong", "t-yisunsin", { type: "faction", label: "조선의 위인" }],
  ["t-sunzi", "t-zhuge", { type: "content", label: "손자병법" }],
  ["t-zhuge", "t-caocao", { type: "faction", label: "삼국지" }],
  ...
  ["t-franklin", "t-washington", { type: "faction", label: "미국 건국의 아버지" }],
  ...
  ["t-oppenheimer", "t-einstein", { type: "faction", label: "맨해튼 프로젝트" }],
  ["t-oppenheimer", "t-feynman", { type: "faction", label: "맨해튼 프로젝트" }],
