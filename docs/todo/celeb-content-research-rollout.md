...
> 시작: 2026-07-29 · 상태: **마이그레이션·배포·기존 양수 Light 감사 완료, 활성 명시 작품군 125명 전수 조사·39명 62건 반영 완료**
...
25. 활성 + 감상여정 비정형 작품명 84명의 제목 추출·표적 검증
...
- 7차 3명은 모두 `full/open`, 실제 콘텐츠 수는 `1·5·1`
- 신규 2종·재사용 5종의 ko/en locale, 출처·감상경위·표지 검증 완료
- 7차에서 건드린 7개 콘텐츠의 `contents.user_count`와 실측 수 불일치 0건
- 다음 대상은 활성 + 감상여정 비정형 작품명 추출군 84명
