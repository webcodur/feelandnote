      ...
      <div className="flex-1 space-y-1.5 min-w-0">
        {files.length === 0 ? (
          ...
          <div className="pt-0.5">
            <button type="button" onClick={add} className="text-xs font-bold text-slate-700 hover:text-accent border border-slate-300 rounded px-2.5 py-1 bg-white hover:bg-slate-50 shadow-sm">+ 사운드 추가</button>
          </div>
        ) : (
