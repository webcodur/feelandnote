 ...
 *
 * 실행 예:
 *   pnpm exec tsx scripts/celeb/reading/audit-quality.ts            # 집계만
 *   pnpm exec tsx scripts/celeb/reading/audit-quality.ts --queue=out.json  # 위반자 큐 저장
 *   pnpm exec tsx scripts/celeb/reading/audit-quality.ts --samples=8       # 위반 유형별 예시 출력
 */
