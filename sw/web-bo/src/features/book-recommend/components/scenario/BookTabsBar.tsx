    ...
    <div>
      <div className="flex gap-1.5 overflow-x-auto pb-1">
        <button
          ...
          className={`shrink-0 inline-flex items-center justify-center px-4 rounded-md border text-sm font-bold whitespace-nowrap ${
            view === VIEW_META
        ...
        {books.map((book, i) => {
          ...
          return (
            <div
              ...
              className={`shrink-0 inline-flex flex-col rounded-md border overflow-hidden ${cardBorder} ${isDragging ? 'opacity-50' : ''}`}
            ...
            >
              <div className="flex items-center">
                ...
                <button
                  ...
                  className={`flex-1 px-3 pt-1.5 pb-0.5 text-sm font-bold whitespace-nowrap text-center cursor-pointer ${
                    isActive
              ...
              <div className={`flex border-t ${isActive ? 'border-accent border-t-2' : 'border-slate-300'}`}>
                <button
                  onClick={() => onSelect(v, 'long')}
                  className={`flex-1 py-0.5 text-sm font-bold font-extrabold cursor-pointer ${
                    isLong
                ...
                <button
                  ...
                  disabled={!hasShorts}
                  className={`flex-1 py-0.5 text-sm font-bold font-extrabold ${
                    !hasShorts
