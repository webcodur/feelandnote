...
- **길이 제한**: 2~8자로 최대한 짧게. 작품명·통용 호칭처럼 줄일 수 없을 때만 12자까지 허용하며 13자 이상은 무효. 소개가 이미 밝히는 국적·직함 수식을 앞에 붙이지 않는다
- **우선순위** (위에서부터 적용):
...
3. **title(수식어)**: 대표작명, 역사적 호칭, 핵심 업적 중 하나만 선택 (2~8자, 불가피하면 12자까지)
