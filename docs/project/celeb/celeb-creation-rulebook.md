...
| # | 단계 | 룰북 | 비고 |
|---|------|------|------|
| 1 | 기본 정보 | `docs/project/celeb/celeb-1-basic-profile.md` | 필수 |
| 2 | 콘텐츠 수집 | `docs/project/celeb/celeb-2-content-collector.md` | full 전용 |
| 3 | 감상 철학 | `docs/project/celeb/celeb-3-philosophy.md` | 필수 |
| 4 | 영향력 평가 | `docs/project/celeb/celeb-4-influence.md` | 필수 |
| 5 | 페르소나 | `docs/project/celeb/celeb-5-persona.md` | 필수 |
| 6 | 고유 대사 | `docs/project/celeb/celeb-8-dialogue.md` | 조건부 (아래 참조) |
...
|---|------|------|------|
| 1 | 기본 정보 | `docs/project/celeb/celeb-1-basic-profile.md` | 필수 |
| 2 | 감상 철학 | `docs/project/celeb/celeb-3-philosophy.md` | 필수 (웹 리서치 기반) |
| 3 | 영향력 평가 | `docs/project/celeb/celeb-4-influence.md` | 필수 |
| 4 | 페르소나 | `docs/project/celeb/celeb-5-persona.md` | 필수 |
| 5 | 고유 대사 | `docs/project/celeb/celeb-8-dialogue.md` | 조건부 (아래 참조) |
