              ...
              {hasAnchor && (
                <div className="pointer-events-auto absolute start-0 end-24 top-0 border-t-2 border-dashed border-warning-text/70">
                  <div
                    ...
                    className="absolute -top-2.5 end-[-5.5rem] flex cursor-grab items-center gap-1 rounded-sm bg-warning/15 px-1.5 py-0.5 text-[10px] font-bold leading-tight text-warning-text shadow-sm active:cursor-grabbing hover:bg-warning/25"
