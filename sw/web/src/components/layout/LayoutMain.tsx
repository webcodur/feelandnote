  ...
  return (
    <>
      ...
      <main className="pt-16 pb-16 px-0 md:pt-24 md:pb-8 md:px-5 min-h-screen [overflow-anchor:none] bg-[radial-gradient(ellipse_at_top,rgba(212,175,55,0.05)_0%,transparent_50%)]">
        <div className={`max-w-[1400px] 2xl:max-w-[1800px] mx-auto border-2 md:border-4 border-double min-h-[calc(100vh-140px)] bg-bg-main px-2 md:px-8 relative mb-4 ${isExplore ? "border-transparent" : "border-accent-dim/20 shadow-[0_0_80px_rgba(0,0,0,0.6)]"}`}>
