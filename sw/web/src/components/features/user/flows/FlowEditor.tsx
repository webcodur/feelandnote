      ...
      <div className="relative w-full max-w-2xl max-h-[90vh] bg-[#111] border border-accent/20 rounded-xl overflow-hidden flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-serif text-text-secondary mb-1">{t("nameLabel")}</label>
              <input
                type="text"
                value={name}
            ...
            <div>
              <label className="block text-sm font-serif text-text-secondary mb-1">{t("descLabel")}</label>
              <textarea
                value={description}
            ...
            <label className="flex items-center gap-2 cursor-pointer">
              ...
              />
              <span className="text-sm text-text-secondary">{t("public")}</span>
            </label>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <h3 className="text-sm font-serif font-bold text-white">{t("stageConfig")}</h3>
              <Button
                unstyled
                onClick={addStage}
