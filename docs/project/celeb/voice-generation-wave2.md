...
- **speech_tone**: loyal
- **사망**: 1431
- **성격 키워드**: 천상의 소명, 10대 농민 소녀의 불굴, 오를레앙·랭스·화형대, 백합 깃발

### ElevenLabs Voice Prompt (KO)

```
20대 초반 프랑스 여성. 깔끔하고 여성스러운 중음역. 음색은 맑지만 말투는 가볍지 않다. 한 마디 한 마디에 신의 사명을 짊어진 자의 무게가 실려 있다. 서두르지 않고 또렷하게 끊어 말한다. 전장에서는 거침없이 호령하되 목소리 자체는 흐트러지지 않는다.
```

### ElevenLabs Voice Prompt (EN)

```
Early 20s French female. Clean, feminine mid-range voice. The tone is clear but never light — every word carries the weight of divine mission. Speaks with deliberate, unhurried clarity. Commands fiercely on the battlefield, yet the voice itself never breaks composure.
```
...
| 유형 | # | 대사 |
|------|---|------|
| greeting | 1 | 두렵지 않습니다. 이 일을 하기 위해 태어났으니까요. |
| greeting | 2 | 오직 천상의 부름에 응하여 검을 들었습니다. |
| greeting | 3 | 오를레앙의 포위망을 뚫고, 랭스의 왕관을 전하께 바치겠습니다. |
| roll_call | 1 | 대천사 미카엘의 음성이 제게 때가 왔음을 알렸습니다. |
| roll_call | 2 | 검을 쥐기에 앞서, 백합의 깃발을 높이겠습니다. |
| roll_call | 3 | 우리가 먼저 움직여야 주님께서도 응답하실 것입니다. |
| deploy | 1 | 프랑스를 구원할 자, 내 깃발 아래로 모여라! |
| deploy | 2 | 투르넬을 향해 나아가라! 오늘 밤 성문은 열릴 것이다! |
| deploy | 3 | 잉글랜드인들이여, 피를 보기 전에 너희 나라로 당장 돌아가라. |
| battle_win | 1 | 랭스로 가는 길이 열렸습니다. 모든 영광을 천상의 왕께 바칩니다. |
| battle_win | 2 | 적들은 물러났고, 오를레앙의 종소리가 다시 울려 퍼집니다. |
| battle_win | 3 | 전장에 쓰러진 모든 가엾은 영혼들에게 주님의 자비가 있기를. |
| battle_draw | 1 | 성벽이 높다 한들 신의 뜻을 막을 순 없습니다. 전열을 재정비하십시오. |
| battle_draw | 2 | 가슴에 화살이 꽂힐지언정, 이 깃발은 꺾이지 않습니다. |
| battle_draw | 3 | 적들은 지쳤습니다. 기도로 밤을 지새우고 날이 밝으면 다시 치겠습니다. |
| battle_lose | 1 | 내 육신은 태워도, 내 영혼을 불사를 수는 없다. |
| battle_lose | 2 | 내가 사로잡혔다 한들, 프랑스는 결국 해방될 것입니다. |
| battle_lose | 3 | 마지막 숨이 멎는 순간까지 제 눈앞에 십자가를 들어주소서. |
| clash_attack | 1 | 주님이 우리보다 앞서신다! 돌파하라! |
| clash_attack | 2 | 성벽에 사다리를 걸어라! 신의 이름으로 나아가라! |
| clash_attack | 3 | 두려움을 버려라! 이미 승리는 우리의 것이다! |
| **quote** | - | 나는 신이 보낸 사자입니다. 프랑스를 구하기 위해 왔습니다. |

### 대사 목록 (EN)

| 유형 | # | 대사 |
|------|---|------|
| greeting | 1 | I am not afraid. I was born for this. |
| greeting | 2 | I took up the sword only in answer to a call from heaven. |
| greeting | 3 | I will break the siege of Orléans and deliver the crown at Reims to my king. |
| roll_call | 1 | The voice of Archangel Michael has told me the time has come. |
| roll_call | 2 | Before I take up the sword, I shall raise the banner of the lily. |
| roll_call | 3 | We must move first — then the Lord will answer. |
| deploy | 1 | All who would save France, rally to my banner! |
| deploy | 2 | March on the Tourelles! Tonight the gates will open! |
| deploy | 3 | Englishmen — go back to your country before blood is spilled. |
| battle_win | 1 | The road to Reims is open. All glory to the King of Heaven. |
| battle_win | 2 | The enemy has retreated, and the bells of Orléans ring once more. |
| battle_win | 3 | May the Lord have mercy on every poor soul who fell on this field. |
| battle_draw | 1 | No wall, however high, can stand against the will of God. Reform the ranks. |
| battle_draw | 2 | Even with an arrow in my chest, this banner will not fall. |
| battle_draw | 3 | The enemy grows weary. We shall pray through the night and strike again at dawn. |
| battle_lose | 1 | You may burn my body, but you cannot burn my soul. |
| battle_lose | 2 | Even if I am captured, France will be free in the end. |
| battle_lose | 3 | Hold the cross before my eyes until the very last breath leaves me. |
| clash_attack | 1 | The Lord goes before us! Break through! |
| clash_attack | 2 | Set the ladders against the wall! Forward, in God's name! |
| clash_attack | 3 | Cast away your fear! Victory is already ours! |
| **quote** | - | I am a messenger sent by God. I have come to save France. |
