/*
  파일명: components/shared/SpectrumStatPanel.tsx
  기능: 스펙트럼 스탯 탭 패널 (능력/품성/성향)
...
import type { StatKey, TendencyKey } from "@/lib/spectrum/constants";
import { localizeSpectrumText } from "@/lib/spectrum/localizeText";
import type { SpectrumStats, SpectrumStatsWithReasons } from "@/lib/spectrum/types";
...
interface SpectrumStatPanelProps {
  stats: SpectrumStats | SpectrumStatsWithReasons | null;
}
...
export default function SpectrumStatPanel({ stats }: SpectrumStatPanelProps) {
  const t = useTranslations("shared.spectrum");
