...
- fiction은 기본 프로필만 만들었다고 끝나지 않는다. 인물이 실제 등장하거나 인물을 다루는 작품을 확인해 `fiction_source_*` 관계까지 연결한다. 현재 규칙은 [`celeb-00-01-pipeline.md`](celeb-00-01-pipeline.md)의 「fiction 원전·등장 도서 연결」이 쥔다.
