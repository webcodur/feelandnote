...
export default function VoiceBadge({ size = "md", pulse = 0, className = "" }: VoiceBadgeProps) {
  ...
  return (
    <div className={`relative flex items-center justify-center ${cfg.badge} rounded-full bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.6)] border border-emerald-400/80 animate-[voiceGlow_2s_ease-in-out_infinite] ${className}`}>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2.5} strokeLinecap="round" strokeLinejoin="round" className={`${cfg.icon} text-white`}>
