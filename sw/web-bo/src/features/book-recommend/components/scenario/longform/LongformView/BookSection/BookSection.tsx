...
export function BookSection({
  ...
  const headerClass = isFocused
    ...
    : `bg-bg-card px-4 py-3 select-none hover:bg-bg-hover list-none ${picking ? 'pointer-events-none' : 'cursor-pointer'}`
          ...
          {!isFocused && (
            <div className="pt-2 flex justify-end">
              <button
                ...
                className="px-2 py-0.5 text-sm font-bold text-text-secondary border border-border/40 rounded hover:border-accent/40 hover:text-accent"
                title="이 책 섹션 접기"
              >▲ 접기</button>
            </div>
          )}
