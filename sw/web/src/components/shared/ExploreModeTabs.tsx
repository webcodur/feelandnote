...
export default function ExploreModeTabs() {
  ...
  return (
    <nav aria-label={t("explore")} className="mx-auto mb-5 grid w-full max-w-sm grid-cols-2 gap-1 rounded-xl border border-white/10 bg-black/20 p-1 md:mb-7 md:max-w-xs">
