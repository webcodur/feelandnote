...
import {
  saveFictionSourceCharacterDescription,
...
interface FictionSourceCharacterDescriptionsProps {
  contentId: string
  sourceTitle: string
...
export default function FictionSourceCharacterDescriptions({
  contentId,
  sourceTitle,
  hasEnglishAmazon,
  assignments,
  characters,
}: FictionSourceCharacterDescriptionsProps) {
  ...
  const handleSave = (assignment: FictionSourceCharacterAssignment) => {
    ...
    startSaving(async () => {
      try {
        await saveFictionSourceCharacterDescription({
          contentId,
