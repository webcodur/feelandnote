...
export const IMAGE_POOL_COLLAPSED_KEY = 'web-bo.book-recommend.imagePool.collapsed'
...
export const POOL_STYLES = {
  ...
  pill: 'px-2 py-0.5 text-[11px] rounded border',
  ...
  toggleBtn: 'px-2 py-0.5 text-[11px]',
  toggleActive: 'bg-accent/20 text-accent',
  toggleIdle: 'text-text-secondary hover:text-accent',
  sectionHeader: 'w-full flex items-center gap-2 px-2 py-1 bg-bg-card/50 hover:bg-bg-hover text-left',
