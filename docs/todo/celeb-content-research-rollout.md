...
> 시작: 2026-07-29 · 상태: **마이그레이션·배포·기존 양수 Light 감사 완료, 활성 명시 작품군 95명 조사·31명 50건 반영 완료**
...
21. 활성 명시 작품군의 남은 30명을 같은 문맥 필터 방식으로 순차 처리
...
- 조사 인물: **95명**
- 근거 통과 인물: **31/95명 = 32.6%**
- 추출 제목: **193개**
- 직접 관계 근거 통과 제목: **48/193개 = 24.9%**
- 판본 게이트까지 통과해 실제 등록: **31명·50건**
- 남은 활성 명시 작품군: **30명**

## 원격 반영 상태

- 스키마 마이그레이션, web-bo·web 배포, 기존 양수 Light 감사 완료
- 파일럿·2차·3차·4차·5차 활성 명시 작품군 반영 완료
- 5차 5명은 모두 `full`, 실제 콘텐츠 수는 `1·1·1·1·3`
- 재사용 7종의 ko/en locale, 출처·감상경위·표지 검증 완료
- 5차에서 건드린 7개 콘텐츠의 `contents.user_count`와 실측 수 불일치 0건
