...
| 속성 | 범위 | 원작 | 용도 |
|------|------|------|------|
| `hp/maxHp` | 0~100 | HP 0~100 | 장수 개인 체력. 전투 피격·치유, 턴마다 자연 회복. 0이면 전사 |
| `troops/maxTroops` | 가변 | 병력 0~1,000 | 장수 휘하 부대 병사 수. 전투 대미지 배율(`troops/500`), 전술별 소모 |
| `morale` | 0~100 | 사기 0~100 | 병력(부대)의 전투 의지. 전투 피격 시 감소, 고무 전술로 회복. 0이면 괴멸 |
| `loyaltyValue` | 0~100 | 충성 0~100 | 이탈 방지. 포상/처벌로 조절 |

원작의 부대 장비(무기 10,000/군마 1,000/조선 1,000/부적 1,000)는 콘텐츠 기반 아이템(`equippedScroll`/`equippedTreasure`)으로 대체.
