...
export default function RankActionButton({
  ...
  return (
    <button
      ...
      className="mx-auto mt-1.5 min-h-5 w-fit shrink-0 cursor-pointer rounded-sm border border-accent/25 bg-white/[0.04] px-1.5 py-0.5 text-[11px] font-bold leading-none text-accent hover:border-accent hover:bg-accent hover:text-black focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent disabled:pointer-events-none disabled:opacity-60"
    >
      {label}
    </button>
  );
