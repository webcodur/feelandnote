...
인물 작업은 [`celeb-00-01-pipeline.md`](celeb-00-01-pipeline.md)에서 실존과 fiction을 먼저 가른다. 공개 여부는 [`celeb-00-02-publication.md`](celeb-00-02-publication.md), 물리 테이블과 제약은 [`../data/03-celeb.md`](../data/03-celeb.md)가 쥔다.

파일명의 두 자리 숫자는 실행 단계가 아니라 탐색기 정렬용 도메인 주소다. 두 번째 숫자는 같은 도메인 안의 읽기 순서이며 문서 제목에는 번호를 붙이지 않는다.

## 티어별 범위

| 도메인 | full | light | fiction |
|---|---|---|---|
| 기본 프로필·아바타·공개 상태 | 적용 | 적용 | 적용 |
| 일반 감상 콘텐츠 | 한 건 이상 | 조사 중 또는 네 유형 0건 확정 | 사용하지 않음 |
| 원전·등장 작품 | 사용하지 않음 | 사용하지 않음 | 적용 |
| 영향력·스펙트럼 | 적용 | 적용 | 만들지 않음 |
| Speech | 한영 | 한영 | 한국어, 영문은 요청 범위 |
| 인물 안내·연표·관계 | 적용 | 적용 | 원전 근거로 적용 |

full과 light는 별도 제작 등급이 아니다. 신규 실존 인물은 light로 시작하고 첫 `celeb_contents` 관계가 생기면 DB가 full로 자동 승격한다. fiction은 일반 감상 관계 대신 원전·등장 작품 관계를 사용하는 독립 분기다.

## 문서 지도

| 주소 | 책임 | 문서 |
|---|---|---|
| 00 | 티어 분기와 공개 경계 | [`celeb-00-01-pipeline.md`](celeb-00-01-pipeline.md) · [`celeb-00-02-publication.md`](celeb-00-02-publication.md) |
...
| 02 | 감상 콘텐츠와 fiction 원전 | [`celeb-02-01-content-research.md`](celeb-02-01-content-research.md) · [`celeb-02-02-content-registration.md`](celeb-02-02-content-registration.md) · [`celeb-02-03-content-review.md`](celeb-02-03-content-review.md) · [`celeb-02-04-content-audit.md`](celeb-02-04-content-audit.md) · [`celeb-02-05-figure-books.md`](celeb-02-05-figure-books.md) |
