...
| **성인** | 聖 | leader | benevolence, charisma | 사기 버프, 치유, 등용 특화 |
...
| **예인** | 藝 | author, musician, visual_artist, director, actor | charisma, intellect | 문화, 민심, 사기 회복 |
| **장인** | 匠 | scientist, entrepreneur | intellect, diligence | 건설, 생산, 공성 |
| **유격** | 遊 | influencer, other | charisma, courage | 정찰, 교란, 빠른 이동 |
...
DIPLOMAT_BASE = charisma×0.2 + intellect×0.15 + command×0.1
```
