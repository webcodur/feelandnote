...
const lines = [
  ...
  { file: "a1", text: "There is still something I do not understand. I cannot stop." },
  { file: "a2", text: "Curiosity leads me. It always has." },
  { file: "a3", text: "Eyes and hands — both are ready." },
