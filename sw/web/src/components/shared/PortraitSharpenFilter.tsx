 ...
 * 뿌옇게 보인다. AI로 다시 그린 초상은 원래 미세 질감이 균질해 더 심하게 뭉갠다
 * (2026-07-28 실측: 실사 394 대 재생성본 346, 화면 표시 크기 기준 고주파 에너지).
 *
 * 3x3 언샤프 커널로 가장자리만 살짝 세운다. 계수를 더 키우면 윤곽에 흰 테가 생기므로
 * 중앙 2.4 / 상하좌우 -0.35를 상한으로 본다.
 *
 * preserveAlpha가 필수다. 배경을 지운 초상이라 알파를 건드리면 테두리가 지저분해진다.
 */
