 ...
 *   node --env-file=.env --import tsx scripts/fiction/monologue-lock.ts --unlock --slugs a,b   # 해제
 *   node --env-file=.env --import tsx scripts/fiction/monologue-lock.ts --list                 # 잠긴 인물 목록
 */
