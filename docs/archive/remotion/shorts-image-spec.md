...
> 아카이브 문서. 아래 수치와 구현 설명은 당시 기록이며 현행 제작 규격이 아니다. 현재 기준은 `docs/project/remotion/book-recommend/image-requirements.md`와 `docs/project/remotion/book-recommend/shorts-image.md`를 따른다.
