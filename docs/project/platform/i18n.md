...
| `faction_lv1`·`faction_lv2`·`faction_lv3` | `name_en`, `description_en` |
...
| 도감(faction_lv*) / 배정(faction_members) | 12 + ~45건 | ✅ |
...
셀럽 데이터의 영문 필드 책임과 fiction 예외는 [`../celeb/celeb-09-01-i18n.md`](../celeb/celeb-09-01-i18n.md)가 쥔다. 활성 인물의 데이터와 화면을 검사할 때는 다음 명령을 쓴다.
...
- `sw/web-bo/scripts/celeb/readings-translate.ts`: 읽어보기 안내의 해시 가드·재개 가능한 번역
...
쿠팡·아마존 계정·지급 준비는 [제휴 판매 운영](../operations/affiliate-commerce.md)이 쥔다.
일반 콘텐츠의 언어와 링크 구조는 [콘텐츠 데이터](../data/02-content.md),
