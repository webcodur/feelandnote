...
> 시작: 2026-07-29 · 상태: **활성 명시 작품군 125명·활성 비정형 작품군 84명 완료, 비정형 7명 10건 반영**
...
- 나머지 77명은 `light/open/0` 유지. `confirmed_empty(-1)` 전환 없음
- 다음 대상은 활성 + 감상여정 없음 4명 전면 조사
