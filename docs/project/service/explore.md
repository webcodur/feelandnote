...
| 경로 | 역할 | 데이터 출처 |
|---|---|---|
| `/explore` | 허브. 4개 미리보기 + 네비게이터 | `getCelebs`, `getTopByContentType`, `getSpectrumDistribution`, `getFeaturedTags`, `getMythAtlas` |
