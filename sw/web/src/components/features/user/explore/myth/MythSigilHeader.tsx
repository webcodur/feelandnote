      ...
      <div className="relative">
        {person.avatarUrl ? (
          <span className="relative mx-auto block size-28 md:size-32">
            ...
            >
              <BlurDissolve key={person.avatarUrl} className="absolute inset-0"><CelebAvatarImage src={person.avatarUrl} alt="" className="object-cover transition-transform duration-500 group-hover:scale-105" style={{ filter: "none" }} /></BlurDissolve>
            </button>
            <button
              type="button"
              onClick={() => setZoomOpen(true)}
