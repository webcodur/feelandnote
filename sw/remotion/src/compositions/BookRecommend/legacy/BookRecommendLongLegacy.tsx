...
import { BookCardVisual, CINEM_PAD } from './BookCardVisualLegacy'
...
import { PortraitSubtitles } from './PortraitSubtitles'
...
export const BookRecommendLegacy: React.FC<Props> = ({ script, episodeName }) => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: DARK.base }}>
      ...
      {/* 상단 브레드크럼 — 영상 전체 표시 (legacy는 글씨 키움) */}
      <Breadcrumb script={script} tl={tl} fontScale={1.5} />
