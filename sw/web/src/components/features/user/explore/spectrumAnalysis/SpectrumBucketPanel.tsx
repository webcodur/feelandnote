/*
  파일명: /components/features/user/explore/spectrumAnalysis/SpectrumBucketPanel.tsx
...
interface SpectrumBucketPanelProps {
  items: { p: SpectrumPerson; v: number }[];
  label: string;
  labelColor?: string;
  negLabel: string;
  posLabel: string;
...
export default function SpectrumBucketPanel({ items, label, labelColor, negLabel, posLabel, colors, hasPrev, hasNext, onPrev, onNext, onSelect }: SpectrumBucketPanelProps) {
