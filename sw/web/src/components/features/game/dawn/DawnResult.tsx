...
export default function DawnResult({
  ...
  return (
    ...
    <div className="max-w-lg mx-auto space-y-6 py-8 px-4 animate-in fade-in duration-500">
      {/* 결과 요약 */}
      <div className="text-center space-y-2">
        ...
        <p className="text-lg font-bold text-white">{streak} <span className="text-sm font-normal text-text-secondary">연속 정답</span></p>
        {isNewRecord && (
