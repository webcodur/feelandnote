...
- `BOTH`는 **세상이 그 인물을 떠올릴 때 신화적 배경까지 함께 떠올리는** 인물이다. 예수·잔 다르크·무함마드·석가모니처럼 신이한 대목이 그 인물을 아는 방식의 일부이거나(예수의 부활, 잔 다르크가 들은 목소리), 주몽·진무·길가메시처럼 전승이 그 인물을 전하는 주된 통로인 경우다. 학계가 갈려 실존·전승 어느 쪽도 단정 못하는 인물도 여기 든다(단군왕검·테세우스).
- **후대에 이야기가 덧붙었다는 사실만으로는 `BOTH`가 아니다.** 유명한 실존 인물에게는 대개 일화가 붙는다. 칭기즈 칸이 핏덩이를 쥐고 태어났다는 대목, 클로비스 1세의 성유병, 키루스 대왕이 버려졌다 살아났다는 대목이 그렇다. 대중은 그들을 그 이야기로 알지 않으므로 `REAL`이다. 판정은 「전승이 기록에 남아 있는가」가 아니라 「사람들이 그 인물을 신화적 배경과 함께 아는가」로 한다.
