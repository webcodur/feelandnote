...
export function FactionImagePicker({ value, onChange, series, episodeName, slug, onClose }: Props) {
        ...
        <div className="space-y-4 p-4">
          ...
          {value && (
            <div className="flex items-center gap-3 rounded-md border border-border bg-bg-secondary p-2">
              <img src={imageSrc(series, episodeName, value)} alt="" className="h-14 w-14 rounded-md object-cover" />
              ...
              <div className="grid grid-cols-4 gap-2">
                {images.map(f => (
                  <div key={f} className="group relative">
                    ...
                    >
                      <img src={imageSrc(series, episodeName, f)} alt="" className="aspect-square w-full object-cover" />
                    </button>
                    <button
