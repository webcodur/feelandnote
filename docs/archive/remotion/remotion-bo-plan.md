...
- 새 화면·창구·저장 규칙: [`web-bo.md`](../../project/apps/web-bo.md) 「가상 담화」 절
- 시리즈 SSoT: [`docs/project/remotion/discourse/`](../../project/remotion/discourse/README.md) · 통합 설계: [`unification.md`](../../project/remotion/discourse/unification.md)
...
[`서재 탐방 1차 통합`](../../project/remotion/book-recommend/unification-phase1.md)이 단일원천이다.
...
- 새 화면·창구·출간 규칙: [`web-bo.md`](../../project/apps/web-bo.md) 「세력도감」 절
- 시리즈 SSoT: [`docs/project/remotion/faction/`](../../project/remotion/faction/README.md) · 통합 설계: [`unification.md`](../../project/remotion/faction/unification.md)
...
- **담화 전용 편집기** — 담화는 **원고 중심**(26.07.21 개편 — 원고 위에서 경계 마킹으로 발언·덩어리 파생, 상세는 `docs/project/remotion/discourse/README.md` §9). 세력도감 편집기(인물 명단·그룹·이미지 풀·음성 패널)는 web-bo로 이관 후 삭제됐다
