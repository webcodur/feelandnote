...
- **`hell-bar`(저승 술집)를 현역으로 취급 금지** — 2026-07-16 폐기됐다(구현된 적 없음). 인물끼리 사상을 부딪치는 자리는 「가상 담화」(`docs/project/remotion/discourse.md`)가 대신하며, 담화는 아직 삼국지 인물을 쓰지 않는다. 기획 보존본은 `docs/archive/hell-bar/README.md`이며 참조 문서로 인용하지 않는다.
