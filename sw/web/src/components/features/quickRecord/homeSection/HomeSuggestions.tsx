                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 px-2 pb-4">
                    {suggestions.map((item) => (
                        <div key={item.id} className="relative flex-none w-full mt-2">
                            ...
                            />
                            <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 bg-black/80 backdrop-blur-md border border-white/10 px-2 py-0.5 rounded-full text-[11px] text-accent flex items-center gap-1 shadow-lg whitespace-nowrap pointer-events-none">
