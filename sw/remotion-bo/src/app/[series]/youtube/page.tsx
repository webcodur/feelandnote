        ...
        {!loading && hasPreviews && (
          <div className="flex items-center gap-1 px-5 pt-3 border-b border-border overflow-x-auto">
            ...
            <button
              ...
              className={`relative px-3 py-1.5 text-xs font-semibold rounded-t border-x border-t transition-colors -mb-px ${
                activeTab === ALL_TAB
            ...
            {previews!.map((p) => {
              ...
              return (
                <button
                  ...
                  className={`relative px-3 py-1.5 text-xs font-mono font-semibold rounded-t border-x border-t transition-colors -mb-px ${
                    isActive
                      ? 'bg-bg-main border-border text-text-primary'
                      : 'bg-bg-card border-transparent text-text-dim hover:text-text-primary hover:bg-bg-hover'
                  }`}
