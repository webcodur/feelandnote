...
async function fetchLibraryByEra(locale: string): Promise<EraLibrary[]> {
  ...
  const eraMap = new Map<string, EraLibrary>()
...
const getLibraryByEraCached = unstable_cache(
  fetchLibraryByEra,
  ['library-by-era'],
