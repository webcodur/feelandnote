  ...
  return (
    <section aria-label="작업 도구" className="flex flex-wrap items-start gap-x-3 gap-y-2 border border-border bg-bg-card px-2 py-2 shadow-sm">
      ...
      <div className="flex min-w-0 flex-1 flex-wrap items-center gap-x-3 gap-y-2">
        ...
        <ToolGroup label="음성">
          <ToolButton icon={<Mic size={15} />} onClick={onOpenVoice}>음성 생성</ToolButton>
      ...
      <div className="ml-auto shrink-0 border-l border-border pl-3">
        <FactionImageSyncBadge folder={folder} reloadKey={imageSyncReloadKey} onOpenPublish={onOpenPublish} />
      </div>
    </section>
  )
}
