    ...
    >
      ...
      >
        ...
        <div className="grid shrink-0 self-center grid-cols-2 gap-1">
          ...
          <button onClick={e => { e.stopPropagation(); onDelete() }} className="rounded-md border border-border p-1.5 text-danger-text hover:bg-danger/15" title="세력 삭제">
            <Trash2 size={15} />
          </button>
                ...
                <div key={ci} className={`rounded-lg border transition-all duration-200 overflow-hidden ${isClusterExpanded ? 'border-border bg-bg-card shadow-sm' : 'border-border bg-bg-main'}`}>
                  ...
                  >
                    ...
                    <div className="flex shrink-0 items-center gap-1 self-center" onClick={e => e.stopPropagation()}>
                      ...
                      <button onClick={() => deleteCluster(ci)} className="rounded-md border border-border p-1.5 text-danger-text hover:bg-danger/15" title="그룹 삭제">
                        <Trash2 size={15} />
                      </button>
                    </div>
                  </div>
