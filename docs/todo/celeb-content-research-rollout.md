...
> 시작: 2026-07-29 · 상태: **활성 명시 작품군 125명 완료, 활성 비정형 작품군 40/84명 조사·3명 6건 반영 완료**
...
27. 활성 + 감상여정 비정형 작품명 41~84번 제목 추출·표적 검증
...
- 활성 비정형 작품군 1~40번 원격 반영·검증 완료
- 맥스웰 `full/open/2`, 프란치스코 `full/open/1`, 람 모한 로이 `full/open/3`
- 등록 6건의 ko/en 감상경위, 출처, locale, 표지, 저장 누적값 결함 0건
- 나머지 37명은 `light/open/0` 유지. `confirmed_empty(-1)` 전환 없음
- 다음 대상은 활성 + 감상여정 비정형 작품명 추출군 41~60번
