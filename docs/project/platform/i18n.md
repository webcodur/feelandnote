...
| 테이블 | 추가 컬럼 |
|--------|----------|
| `celebs` | `title_en`, `bio_en`, `virtual_monologue_en`. 감상여정 한영 컬럼은 서비스에서 사용하지 않으며 `quotes_en` 컬럼은 없음 |
...
- CelebForm: nickname_en, title_en, bio_en
...
- celebs/[id] 상세: DialogueSection (KO/EN 토글)
