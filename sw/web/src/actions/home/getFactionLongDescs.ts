...
/*
  ...
  전 테마 명단(getFeaturedTags)에 함께 싣던 때 긴 소개가 2.2MB를 차지해 명단이 캐시 상한 2MB를 넘었고,
...
export async function getFactionLongDescs(tagId: string): Promise<FactionLongDescs> {
  return getCachedFactionLongDescs(tagId)
}
