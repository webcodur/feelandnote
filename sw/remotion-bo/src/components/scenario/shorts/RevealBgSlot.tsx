    ...
    >
      ...
      {fileName ? (
        <div className="group/rv flex items-center gap-2">
          ...
          <button onClick={onRemove} className="text-red-400 hover:text-red-300 text-sm font-bold opacity-0 group-hover/rv:opacity-100 transition-opacity">&times;</button>
        </div>
      ) : (
