...
export default function DeveloperCollectionJourney({ target, placement, context, showPreview = placement !== "content-detail" }: {
  target: JourneyTarget; placement: string; context?: string; showPreview?: boolean;
}) {
  ...
  if (!id) return placement === "celeb-review" || placement === "content-detail" || placement === "creative-work"
    ...
    : null;
  return <CollectionJourney key={id} id={id} placement={placement} context={context} compact showPreview={showPreview} />;
}
