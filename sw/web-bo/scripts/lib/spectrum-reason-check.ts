 ...
 *                            26.09.13 전수 판정에서 갈린 기준 — 「사치나 방종 기록이 없음」처럼 부정적 행위의 부재를 적은
 *                            문장, 「유죄판결 뒤에도 반성 기록 없음」처럼 확정된 사건 뒤의 태도를 적은 문장은 점수를
 *                            스스로 지탱하므로 유지한다. 「자선 행적 확인되지 않음」처럼 긍정적 행위를 못 찾았다는
 *                            말뿐이거나, 폭로·의혹·기소처럼 확정되지 않은 주장을 점수로 옮긴 것만 중립대로 돌린다.
