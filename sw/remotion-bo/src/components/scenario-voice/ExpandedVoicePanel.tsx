...
import { getTextsForSection, prodFile, sectionVoicePath, readSegmentVoiceMeta, sectionStyleKey, isCelebSection, NARRATOR_STYLE_DEFAULT } from './utils'
...
const BTN_GEM = `${BTN_SM} bg-blue-500/20 text-blue-300 border border-blue-500/40 hover:bg-blue-500/30 disabled:opacity-50 disabled:cursor-not-allowed`
...
type GenEngine = EngineKind | 'gemini-v3'
