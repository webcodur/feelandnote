...
import { MUSEUM_CATEGORY_IDS } from "@/constants/libraryMuseum";
...
const REPRESENTATIVE_IMAGES: Record<string, string> = {
  // 책
  "book/media":        "/images/library/book/media/08_metal_type.jpg",       // 금속활자 — 인쇄 혁명
  "book/writing_tool": "/images/library/book/writing_tool/03_quill_pen.png", // 깃펜 — 필기구의 상징
  "book/typography":   "/images/library/book/typography/07_blackletter.png",  // 블랙레터 — 서체의 아이콘
  // 영상
  "video/media":       "/images/library/video/media/03_silent_film.png",     // 무성영화 — 영화의 탄생기
  "video/technique":   "/images/library/video/technique/05_cgi_era.png",     // CGI — 시각효과의 대표
  "video/space":       "/images/library/video/space/02_movie_palace.png",    // 무비 팰리스 — 극장의 상징
  // 음악
  "music/media":       "/images/library/music/media/04_lp_vinyl.png",        // LP — 음반 매체의 아이콘
  "music/instrument":  "/images/library/music/instrument/04_piano.png",      // 피아노 — 악기의 대표
  "music/experience":  "/images/library/music/experience/concert_hall.png",  // 콘서트홀 — 감상 경험의 정점
  // 게임
  "game/platform":     "/images/library/game/platform/07_home_console.png",  // 가정용 콘솔 — 게임의 상징
  "game/interface":    "/images/library/game/interface/05_analog_haptic.png", // 아날로그 스틱 — 현대 입력장치
  "game/graphics":     "/images/library/game/world/05_seamless_openworld.png", // 오픈월드 — 그래픽 진화의 정점
};
            ...
            >
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 px-3 pb-3">
                {subs.map((sub) => (
                  <Link
                    key={sub.id}
                    href={`/explore/works/museum?cat=${key}&sub=${sub.id}`}
