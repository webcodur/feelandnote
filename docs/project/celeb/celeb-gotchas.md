...
| 시점 | 새어 들어간 곳 | 증상 | 규모 |
|------|----------------|------|------|
| 26.07.26 | 인물 관계망 화면 | 비공개 상대가 가계도 양쪽 어디에도 안 뜸 | 관계 57건·인물 39명 |
| 26.07.27 | 세력도감 태그 조회 | 팩션 등록 인물이 13개 테마에서 사라짐 | 42명 |
| **26.08.07** | **콘텐츠 조사 표시값** | **조사도 안 한 인물이 「조사 완료」(-1)로 보여 조사 대상에서 빠짐** | **588명**(비활성 364·정지 224) |
