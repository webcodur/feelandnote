          ...
          {collapsible && !icon && (
            <div className="absolute top-1.5 left-1.5 z-10 flex items-center">
              <button
                ...
                className="text-text-primary hover:text-accent w-5 h-5 flex items-center justify-center rounded hover:bg-bg-hover transition-colors focus:outline-none font-bold"
                title="접기"
              >
          ...
          <div className="absolute top-1 left-1.5 z-10 flex items-center h-5">
            {collapsible && !icon && (
              <button
                ...
                className="text-text-primary hover:text-accent w-5 h-5 flex items-center justify-center rounded bg-bg-secondary hover:bg-bg-hover transition-colors focus:outline-none font-bold"
                title="펼치기"
              >
