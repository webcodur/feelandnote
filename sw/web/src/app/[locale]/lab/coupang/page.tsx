/*
  파일명: /app/lab/coupang/page.tsx
  기능: 쿠팡 파트너스 링크 관리 페이지
  책임: CoupangPartners 컴포넌트를 렌더링한다.
*/ // ------------------------------

import CoupangPartners from "@/components/lab/CoupangPartners";
import { LAB_ITEMS } from "@/constants/lab";

const item = LAB_ITEMS.find((i) => i.value === "coupang")!;
