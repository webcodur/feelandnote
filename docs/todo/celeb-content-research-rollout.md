...
> 시작: 2026-07-29 · 상태: **마이그레이션·배포·기존 양수 Light 감사 완료, 활성 명시 작품군 75명 조사·26명 43건 반영 완료**
...
18. 활성 명시 작품군의 남은 50명을 같은 문맥 필터 방식으로 순차 처리
...
- 조사 인물: **75명**
- 근거 통과 인물: **26/75명 = 34.7%**
- 추출 제목: **156개**
- 직접 관계 근거 통과 제목: **40/156개 = 25.6%**
- 판본 게이트까지 통과해 실제 등록: **26명·43건**
- 남은 활성 명시 작품군: **50명**
...
- 파일럿·2차·3차·4차 활성 명시 작품군 반영 완료
- 4차 5명은 모두 `full`, 실제 콘텐츠 수는 `1·1·1·2·4`
- 신규 7종의 ko/en locale 14행, 출처·감상경위·표지 검증 완료
- 4차에서 건드린 9개 콘텐츠의 `contents.user_count`와 실측 수 불일치 0건
