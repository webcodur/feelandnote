/*
  파일명: /app/lab/clash-arena/page.tsx
  기능: 접전 미니게임 테스트 Lab 페이지
  책임: ClashArenaStudio 컴포넌트를 Lab 레이아웃 안에서 렌더링한다.
*/

import ClashArenaStudio from "@/components/features/game/duel/ClashArenaStudio";
import { LAB_ITEMS } from "@/constants/lab";

const item = LAB_ITEMS.find((i) => i.value === "clash-arena")!;
