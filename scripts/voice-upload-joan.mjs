/**
 * R2 보이스 파일 업로드 — 잔 다르크 KO
 * Usage: node scripts/voice-upload-joan.mjs
 */
...
const CELEB_ID = "9508ba04-50f6-488b-939f-1328d0293685";

const uploads = [
  { locale: "ko", dir: "c:/Users/webco/Downloads/다르크" },
];
