...
export default function PlaylistDetailView({ playlistId }: PlaylistDetailViewProps) {
  ...
  const handleEdit = () => {
    // ArchiveView로 이동하면서 edit 모드 활성화
      ...
      <div className="space-y-2">
        {playlist.items.map((item, index) => (
          <div
            ...
            className={`flex items-center gap-3 p-3 bg-bg-card rounded-xl cursor-pointer transition-all hover:bg-bg-secondary ${
