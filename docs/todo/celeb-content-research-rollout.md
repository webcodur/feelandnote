...
> 시작: 2026-07-29 · 상태: **마이그레이션·배포·기존 양수 Light 감사 완료, 활성 명시 작품군 115명 조사·36명 55건 반영 완료**
...
24. 활성 명시 작품군의 남은 10명을 같은 문맥 필터 방식으로 순차 처리
...
- 조사 인물: **115명**
- 근거 통과 인물: **36/115명 = 31.3%**
- 추출 제목: **242개**
- 직접 관계 근거 통과 제목: **57/242개 = 23.6%**
- 판본 게이트까지 통과해 실제 등록: **36명·55건**
- 남은 활성 명시 작품군: **10명**

## 원격 반영 상태

- 스키마 마이그레이션, web-bo·web 배포, 기존 양수 Light 감사 완료
- 파일럿·2차·3차·4차·5차·6차 활성 명시 작품군 반영 완료
- 6차 5명은 모두 `full`, 실제 콘텐츠 수는 `1·1·1·1·1`
- 신규 4종·재사용 1종의 ko/en locale, 출처·감상경위·표지 검증 완료
- 6차에서 건드린 5개 콘텐츠의 `contents.user_count`와 실측 수 불일치 0건
