  ...
  return (
    <div>
      <button
        ...
        className="w-full flex items-center gap-2 px-2.5 py-2 text-left cursor-pointer select-none outline-none bg-slate-100 hover:bg-slate-200 border border-slate-400 rounded shadow-xs"
      >
        ...
        <div className="mt-2 p-3.5 space-y-2 border border-slate-400 bg-slate-50 rounded-lg shadow-sm">
          ...
          <div className="pt-1">
            <button
              type="button"
              onClick={addSpeaker}
              className="text-sm font-bold px-2.5 py-1 rounded border border-accent text-accent hover:bg-accent/15 cursor-pointer font-bold shadow-xs"
            >+ 화자 추가</button>
          </div>
        </div>
      )}
