...
create table public.discourse_speakers (
  ...
  slug text,                            -- celebs.slug 읽기용 미러
  celeb_id uuid not null references public.celebs(id) on delete restrict,
