    ...
    >
      <div className="flex items-center justify-end">
        <button
          ...
          className="flex items-center gap-1 rounded border border-slate-300 bg-white px-2 py-1 text-xs font-extrabold text-slate-700 shadow-sm hover:border-accent hover:text-accent active:scale-95 transition-all"
        >
