...
const lines = [
  ...
  { file: "r1", text: "The voice of Archangel Michael has told me the time has come." },
  { file: "r2", text: "Before I take up the sword, I shall raise the banner of the lily." },
  { file: "r3", text: "We must move first — then the Lord will answer." },
