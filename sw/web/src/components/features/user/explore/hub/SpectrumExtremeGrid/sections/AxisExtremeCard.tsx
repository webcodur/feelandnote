/*
  파일명: /components/features/user/explore/hub/SpectrumExtremeGrid/sections/AxisExtremeCard.tsx
  기능: 일반 축 극단 카드
...
export default function AxisExtremeCard({
  ...
  onCardClick: (entry: SpectrumExtremeEntry, isOpposing: boolean, color: string) => void;
}) {
