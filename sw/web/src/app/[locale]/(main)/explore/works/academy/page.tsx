/*
  파일명: /app/(main)/explore/works/academy/page.tsx
  기능: 서가 - 학당 카테고리 허브
  ...
  상호작용 규약 (docs/project/platform/code-rules.md "상호작용" 절):
...
export async function generateMetadata() {
  ...
  return { title: t("metaTitle"), description: t("metaDescription"), alternates: await getLocalizedAlternates("/explore/works/academy") };
}
