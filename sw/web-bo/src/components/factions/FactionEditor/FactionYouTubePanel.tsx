...
// #region 타입 — youtube/status·youtube/sync 응답 형태(세력도감 한국어 세로 2종 전용)
  ...
  return (
    <div className="space-y-4 rounded-lg border border-border bg-bg-card/40 p-4">
      ...
      {canUpload ? (
        ...
        <div className="rounded-md border border-danger/40 bg-danger/20 px-3 py-2 text-sm text-danger-text">
        ...
        <div className="rounded-md border border-danger/40 bg-danger/20 px-3 py-2 text-sm font-semibold text-danger-text">
                ...
                {rec?.videoId ? (
                  <>
                    ...
                    <button
                      ...
                      disabled={busy}
                      className="flex items-center gap-1 rounded-md border border-border px-2 py-1 text-xs font-semibold text-danger-text hover:bg-danger/15 disabled:opacity-50"
