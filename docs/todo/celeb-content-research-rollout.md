...
> 시작: 2026-07-29 · 상태: **활성 명시 작품군 125명 완료, 활성 비정형 작품군 20/84명 조사·2명 3건 반영 완료**
...
26. 활성 + 감상여정 비정형 작품명 21~84번 제목 추출·표적 검증
...
- 활성 비정형 작품군 1~20번 원격 반영·검증 완료
- 맥스웰 `full/open/2`, 프란치스코 `full/open/1`; 나머지 18명 `light/open/0`
- 등록 3건의 ko/en 감상경위, 출처, locale, 표지, 저장 누적값 결함 0건
- 다음 대상은 활성 + 감상여정 비정형 작품명 추출군 21~40번
