        ...
        {isEmpty ? (
          ...
          <>
            ...
            {err ? (
              ...
              <MediaThumb fileName={img.file} imageBaseUrl={imageBaseUrl} className="w-full h-full object-cover" onError={() => setFailedFile(img.file)} />
            )}
