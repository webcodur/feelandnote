/**
 * 인라인 SVG 아이콘 한 벌 — 화면 전체가 여기서 가져다 쓴다.
 *
 * 외부 아이콘 패키지를 설치하지 않는 환경이라 직접 그린다(lucide 와 같은 24 그리드).
 * 세력도 폴더 안에 있던 것을 공용 자리로 올렸다 — 담화·사진 부품도 같은 아이콘을 쓰는데
 * 세력도 경로를 거쳐 가져오는 모양새였다. 아이콘은 여기 한 파일에만 둔다.
 */
